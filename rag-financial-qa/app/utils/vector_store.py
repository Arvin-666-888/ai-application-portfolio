...
from app.utils.retrieval import financial_v2_rank, lexical_overlap_score, rank_contexts
...
class VectorStore:
    ...
    def query_financial_v2(
        ...
        ranking = financial_v2_rank(query_text, channels, top_k=max(top_k, candidate_limit))
