...
async def get_datasources(
    ...
    return list_datasources(repositories.datasources, current_user.id)
...
async def create_ds(
    ...
    try:
        ds = create_datasource(repositories.datasources, req.name, req.db_type, req.connection_string, current_user.id)
        return ds
...
async def get_schema(
    ...
    try:
        connector = get_connector_for_ds(repositories.datasources, ds_id, current_user.id)
...
async def remove_ds(
    ...
    try:
        delete_datasource(repositories.datasources, ds_id, current_user.id)
